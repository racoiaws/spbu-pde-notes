Если вам не нравится Papeeria и/или хочется работать локально, то в качестве комилятора рекомендуется использовать **XeLaTeX**. Некоторые нужные пакеты: `amsmath`, `polyglossia`, `doublestroke`, `esint`.		
