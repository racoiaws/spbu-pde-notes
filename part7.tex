...
\begin{reminder}[Про слабую топологию] Пусть $H$ - сепарабельное гильбертово пространство. Тогда говорят, что последовательность сходится слабо
...
\begin{lemma} Оператор обобщённого дифференцирования слабо непрерывен.
\end{lemma}

\begin{example}[Пример последовательности, сходящейся слабо, но не сходящейся сильно] Рассмотрим ряд функции $f$, сходящийся в смысле $L^2$:
...
% 4. замкнутое выпуклое подмножество гильбертова пр-ва слабо замкнуто
